...
class SliderAdmin(admin.ModelAdmin):
	list_display = ('titulo','activo', 'imagen_proyecto_slider')
...
class TrabajoAdmin(admin.ModelAdmin):
	list_display = ('titulo','descripcion','activo', 'imagen_proyecto_trabajo')
...
class OfertaAdmin(admin.ModelAdmin):
	list_display = ('titulo', 'descripcion','precio', 'activa', 'imagen_proyecto_oferta')
...
class EmpleadoAdmin(admin.ModelAdmin):
	list_display = ('nombre','cargo','activo', 'imagen_proyecto_empleado')
